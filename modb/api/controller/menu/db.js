...
module.exports = {
	...
	save(data) {
		return new Promise((resolve, reject) => {
			...
			MenuModel.create(data, (error, doc) => {
				if(error){
					reject(error)
				}else{
					resolve(doc)
	...
	find(data={}, fields = null, options={}) {
		return new Promise((resolve, reject) => {
			...
			MenuModel.find(data, fields, options, (error, doc) => {
				if(error){
					reject(error)
				}else{
					resolve(doc)
	...
	findOne(data) {
		return new Promise((resolve, reject) => {
			...
			MenuModel.findOne(data, (error, doc) => {
				if(error){
					reject(error)
				}else{
					resolve(doc)
	...
	findById(data) {
		return new Promise((resolve, reject) => {
			...
			MenuModel.findById(data, (error, doc) => {
				if(error){
					reject(error)
				}else{
					resolve(doc)
	...
	update(conditions, update) {
		return new Promise((resolve, reject) => {
			...
			MenuModel.update(conditions, update, (error, doc) => {
				if(error){
					reject(error)
				}else{
					resolve(doc)
	...
	updateOne(conditions, update) {
		return new Promise((resolve, reject) => {
			//model.update(查询条件,更新对象,callback)
			MenuModel.updateOne(conditions, update, (error, doc) => {
				if(error){
					reject(error)
				}else{
					resolve(doc)
	...
	remove(conditions) {
		return new Promise((resolve, reject) => {
			...
			MenuModel.remove(conditions, (error, doc) => {
				if(error){
					reject(error)
				}else{
					resolve(doc)
